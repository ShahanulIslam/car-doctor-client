            ...
            <div id="slide1" className="carousel-item relative w-full h-[600px]">
                ...
                <div className="absolute flex rounded-xl items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-6xl font-bold'>Affordable price for cars</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut assumenda porro iure cumque? Optio laboriosam veniam veritatis sunt sequi soluta!</p>
